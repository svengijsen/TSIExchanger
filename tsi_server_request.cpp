...
TSI_Server_Request::TSI_Server_Request(QTcpSocket *tcpSocket,QQueue<QString> *querryQueue, QString querry) 
{
...
TSI_Server_Request::~TSI_Server_Request()
{
	querryQueueinternal->dequeue();
}


bool TSI_Server_Request::sendData(char *Querry,int value0, int value1, int value2, int value3)
{
	QByteArray requ;
...
bool TSI_Server_Request::sendQByteArray(QByteArray dataToSend)
{
...
QString TSI_Server_Request::getReply()
{
